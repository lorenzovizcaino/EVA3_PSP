...
public class Servidor {
    ...
    private static void crearDatos() {
        ...
        asignaturas1[0]=lm;asignaturas1[1]=prog;asignaturas1[2]=cs;
        asignaturas2[0]=si;asignaturas2[1]=bd;asignaturas2[2]=psp;
        asignaturas3[0]=ad;asignaturas3[1]=di;asignaturas3[2]=pmdm;
        asignaturas4[0]=sxe;asignaturas4[1]=fol;asignaturas4[2]=eyp;
